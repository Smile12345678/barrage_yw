...
export class Simulator {
    ...
    setAgentPrefVelocity(aid: number, velocity: Vector2 | cc.Vec2) {
     ...
     * @returns 
     */
    addAgent(position: Vector2 | cc.Vec2, radius: number = null, maxSpeed: number = null, velocity: Vector2 = null, mass: number = null) {
